...
import com.xsd.safecardapp.views.LockPatternView.DisplayMode;
...
public class CreateGesturePasswordActivity extends Activity implements
	...
	private void saveChosenPatternAndFinish() {
		...
		System.out.println("fsfsdfsdfsdfds1"+App.getInstance());
		System.out.println("fsfsdfsdfsdfds2"+App.getInstance().getLockPatternUtils());
		System.out.println("fsfsdfsdfsdfds"+mChosenPattern);
		
		SharedPreferences sp = getSharedPreferences("config", MODE_PRIVATE);
		sp.edit().putBoolean("isSetGesture", true).commit();
		sp.edit().putBoolean("isOpenGesture", true).commit();
